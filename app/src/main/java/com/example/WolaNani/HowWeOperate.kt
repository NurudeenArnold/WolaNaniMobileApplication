...
class HowWeOperate : AppCompatActivity() {
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        setContentView(R.layout.activity_how_we_operate)
        ...
        navigationView.setNavigationItemSelectedListener {
            when (it.itemId) {
                ...
                R.id.user -> {
                    ...
                    Toast.makeText(this@HowWeOperate,"Successfully Logged out", Toast.LENGTH_SHORT).show()
                    finish()
                }
            }
            true
