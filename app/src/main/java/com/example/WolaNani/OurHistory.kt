...
class OurHistory : AppCompatActivity() {
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        setContentView(R.layout.activity_our_history)
        ...
        navigationView.setNavigationItemSelectedListener {
            when (it.itemId) {
                ...
                R.id.user -> {
                    ...
                    Toast.makeText(this@OurHistory,"Successfully Logged out", Toast.LENGTH_SHORT).show()
                    finish()
                }
            }
            true
